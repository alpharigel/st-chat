...
class Chat extends StreamlitComponentBase {
  public render = (): ReactNode => {
    ...
    const { isUser, avatarStyle, seed, message, logo, allow_html, is_table, noIcon } = this.props.args;
    ...
    const avatarTag = (noIcon ? '' : <Avatar src={avatarUrl} alt="profile" draggable="false"/> )
